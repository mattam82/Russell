...
with typ : env -> term -> term -> Prop :=
  ...
  | type_pair :
      ...
      typ e u U ->
      forall v V,
      typ e v (subst u V) -> typ e (Pair u v) (Sum U V)
  | type_prod :
      forall e T s1,
      typ e T (Srt s1) ->
      forall (U : term) s2,
  ...
  | type_let_tuple :
      ...
      typ e t (Sum U V) ->
      forall v M,
      typ (V :: U :: e) v M -> typ e (Let_tuple t v) M

  | type_let_in :
      forall e t U,
      typ e t U ->
      forall v M,
      typ (U :: e) v M -> typ e (Let_in t v) M
...
Qed.
  ...
  Definition inv_type (P : Prop) e t T : Prop :=
    ...
    | Pair u v => 
        forall U V, typ e u U -> typ e v (subst u V) -> conv T (Sum U V) -> P
    | Prod A B =>
        forall s1 s2,
    ...
    | Let_tuple t v =>
        forall U V,
        typ e t (Sum U V) -> 
        forall M, typ (V :: U :: e) v M -> conv T M -> P
    | Let_in t v =>
        forall U, typ e t U -> 
        forall M, typ (U :: e) v M -> conv T M -> P
    end.
...
apply H1 with U0 V0 M; auto with coc core arith datatypes.
...
apply H4 with U V; auto with coc core arith datatypes.

apply H4 with s1 s2; auto with coc core arith datatypes.
apply H4 with s1 s2; auto with coc core arith datatypes.
apply H4; auto with coc core arith datatypes.

apply H4 with U V M; auto with coc core arith datatypes.
...
Qed.
  ...
  Lemma inv_typ_pair :
   ...
   typ e (Pair u v) T ->
   (forall U V : term,
    typ e u U -> typ e v (subst u V) -> conv T (Sum U V) -> P) -> P.
intros.
...
apply typ_inversion with (V :: U :: e0) v M; auto with coc core arith datatypes.
