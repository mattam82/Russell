...
\begin{proof}
  ...
  \begin{induction}
    ...
    \begin{induction}
      ...
      Par le lemme \ref{narrowing-i-coercion} on obtient la dérivation
      ...
      $e_1, e_2$ telles que:
      \[\subimpl{`D}{e_1 `= c_1' `o d_1}{S}{X} `^
      \subimpl{`D, x : S}{e_2 `= d_2 `o c_2'}{Y}{T}\]
      ...
      \begin{equations}
        ...
        {\hat{=}}{(\lambda x : \ip{S}{`D}.d_2[\ctxdot~d_1[x]]) `o (\lambda
        ...
        {\hat{=}}{\lambda x : \ip{S}{`D}.d_2[c_2[`q][\ctxdot~c_1[`q][d_1[x]]]]}
      ...
      \begin{eqnarray*}
        d `o c[`r] & \hat{=} & (\elt{\ip{U'}{`D}}
        {\ip{\lambda x : U'.P}{`D}}{e}
        {\ex{\ipG{`D}}{\ip{P}{`D}[e/x]}})[c[`r]] \\
        & = & \elt{\ip{U'}{`D}}
        {\ip{\lambda x : U'.P}{`D}}{e[c[`r]]}
        {\ex{\ipG{`D}}{\ip{P}{`D}[e[c[`r]]/x]}} \\
        & `= & \elt{\ip{U'}{`D}}
        {\ip{\lambda x : U'.P}{`D}}{f}
        {\ex{\ipG{`D}}{\ip{P}{`D}[f/x]}} \\
        & \hat{=} & d'
    ...
    \begin{prooftree}
      ...
      \BIC{$\subimpl{`D}
        {d = \pair{\ip{\Sigma x :
              X.Y}{`D}}{d_1[\pi_1~\ctxdot]}{d_2[\pi_1~\ctxdot/x][\pi_2~\ctxdot]}}
    ...
    \begin{induction}
      ...
      \ref{narrowing-i-coercion}) on a $\subimpl{`D}{c_1'}{S}{X'}$ avec $c_1' `= c_1[`r]$.
    ...
    \begin{induction}
      ...
      \begin{eqnarray*}
        c_2 `o c_1[`r] & = & 
        (\elt{\ip{U'}{`D}}{\ip{\lambda x : U'.P'}{`D}}{c_2'}
        {\ex{\ipG{`D}}{\ip{P'}{`D, x : U'}[c_2'/x]}}) `o c_1[`r]
        & = &
        \elt{\ip{U'}{`D}}{\ip{\lambda x : U'.P'}{`D}}{c_2'[c_1[`r]]}
        {\ex{\ipG{`D}}{\ip{P'}{`D, x : U'}[c_2'[c_1[`r]]/x]}}
        & = & \elt{\ip{U'}{`D}}{\ip{\lambda x : U'.P'}{`D}}{d}
        {\ex{\ipG{`D}}{\ip{P'}{`D, x : U'}[d/x]}} \\
        & = & c'
      \end{eqnarray*}
...
\begin{proof}
  ...
  et unicité des coercions, $f `=
  \ctxdot$ et $f^{-1} `= \ctxdot$. En général $f$ et
  $f'$ sont en forme $\eta$-longue.
\end{proof}
