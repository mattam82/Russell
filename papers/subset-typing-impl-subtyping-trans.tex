...
\begin{lemma}[Symétrie de la coercion]
  ...
  \subimpl{`G}{c^{-1}}{B}{A}$ et $c^{-1} `o c \eqbre \ctxdot \eqbr c `o c^{-1}$.
\end{lemma}
\begin{proof}
  ...
  $\subimpl{`G}{f \eqbr c^{-1} `o c}{A}{A}$ et $\subimpl{`G}{f^{-1}
    \eqbr c `o c^{-1}}{B}{B}$. Par réflexivité (lemme \ref{coerce-refl})
  et unicité des coercions, $f \eqbre
  \ctxdot$ et $f^{-1} \eqbre \ctxdot$. En général $f$ et
