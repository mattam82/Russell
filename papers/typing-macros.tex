...
\def\typedwf{\judgewf}
\def\typea{\judgetypea}
\def\typeawf{\judgetypea}
\def\typei{\judgetypei}
\def\typeiwf{\judgetypei}
\def\typecci{\vdash_{CCI}}
\def\typec{\vdash_{CCI}}
\def\typeq{\vdash_{?}}
\def\type{\typed}
\def\typewf{\typedwf}
...
\newcommand{\tgensub}[4]{#1 \type #2 : #3 \quad #1 \type #3 \sub #4}
\newcommand{\talgo}[3]{#1 \typea #2 : #3}
\newcommand{\talgosub}[4]{#1 \typea #2 : #3 \suba #4}
...
\renewcommand{\case}[1]{\item[\inductioncasepoint{}] \rulename{#1} :}
