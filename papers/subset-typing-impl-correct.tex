...
\begin{proof}
  ...
  par réduction du sujet $\talgo{`G}{t'}{T'}$ avec $T' \sub T$ pour tout $t'$ tel que $t "->"_{\beta\rho} t'$. 
  ...
  \begin{induction}
    ...
    \begin{prooftree}
      ...
      {$\subalgo{`G}{B'}{B[e_1/x]} \quad \subalgo{`G}{B'}{B[e_1'/x]}$}
...
\begin{proof}
  ...
  \begin{induction}
    ...
    \begin{prooftree}
      ...
      {$\subalgo{`G}{B'}{B[e_1/x]} \quad \subalgo{`G}{D'}{D[e_1'/x]}$}
      {$\teq{`G}{\pair{\Sigma x : A.B}{e_1}{e_2}}{\Sigma x : A.B}{\pair{\Sigma x :
