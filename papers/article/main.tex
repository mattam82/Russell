...
support of the subset. On the other hand, \irule{SubProof} creates and
...
\begin{proposition}[Coercion transitivity]
...
\begin{example}[Transitivity needs eta]
  Let $T, U, V = \Pi x : A.B$.
  ...
  Suppose all $c^i_j$ have been derived by \irule{SubConv}. Then we have 
  $c_2 `o c_1 = $.
...
\ccieqfig[Equational theory of \CCq]
