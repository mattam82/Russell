...
the judgement which builds a coercion given two types (we denote it $\coerce{`G}{T}{U}$). 
The side-conditions of the rules have not changed, so we omit them for
better readability. The judgement $\subimpl{`G}{c}{T}{U}$ builds a
...
avoiding the complicated proof obligation generation of \PVS.
