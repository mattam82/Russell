...
shows the relation between input and output, using a dependent type, yet the
...
judgements of the two systems in section \ref{sec:Translation}. Then, we present a prototype
