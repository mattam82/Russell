...
\begin{paragraph}{}
  ...
  "<=>" T \eqbp U `^ `G \type T, U : s$ in \Coq). 
  Clearly, we can eliminate symmetry directly, given the fact that
...
language if we want to be conservative and have uniqueness of
...
%%% TeX-master: t
%%% LaTeX-command:
%%% "BIBINPUTS=\"${HOME}/research/demons-biblio:../bib:$BIBINPUTS\"
%%% TEXINPUTS=\"${HOME}/.latex:..:../style:$TEXINPUTS\" latex"
%%% End: 
