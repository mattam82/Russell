...
\institute[]
{
  ...
  \LRI{} - Équipe \Demons{} \& \INRIAFuturs{} - Projet \Proval{} 
}
...
\begin{frame}[t]
  ...
  \begin{enumerate}
  \item<1-> Un langage ``property-irrelevant'' (\lng{}) avec typage \alert{décidable} ;
...
%      \SubSigma\DP}
  ...
  \only<6>{\begin{theorem}[Décidabilité du typage]
...
\begin{frame}[t]
  \frametitle{Traduction: dérivation de coercions explicites}
...
\begin{frame}
  ...
  \begin{block}{Travaux en cours et futurs}
    ...
    \item Donner une interprétation relativement complète et utile des
