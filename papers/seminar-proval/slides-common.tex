...
\coqdocindent{1.00em}
\coqor  \coqdocid{Empty} : \coqdocid{fingertree} \coqdocid{measure} $\varepsilon$\coqdoceol
\coqdocindent{1.00em}
\coqor  \coqdocid{Single} : \ensuremath{\forall} \coqdocid{x} : \coqdocid{A}, \coqdocid{fingertree} \coqdocid{measure} (\coqdocid{measure} \coqdocid{x})\coqdoceol
\coqdocindent{1.00em}
\coqor  \coqdocid{Deep} : \ensuremath{\forall} (\coqdocid{l} : \coqdocid{digit} \coqdocid{A}) (\coqdocid{m} : \coqdocid{v})\coqdoceol
\coqdocindent{2.00em}
(\coqdocid{x} : @\coqdocid{fingertree} (\coqdocid{node} \coqdocid{measure}) \coqdocid{nodeMeasure} \coqdocid{m})\coqdoceol
\coqdocindent{2.00em}
(\coqdocid{r} : \coqdocid{digit} \coqdocid{A}), \coqdoceol
\coqdocindent{2.00em}
\coqdocid{fingertree} \coqdocid{measure} (\coqdocid{digit\_measure} \coqdocid{measure} \coqdocid{l} $\cdot$ \coqdocid{m} $\cdot$ \coqdocid{digit\_measure} \coqdocid{measure} \coqdocid{r}).\coqdoceol

\pause
\medskip
\coqdocindent{2.00em}
\coqdockw{Program Fixpoint} \coqdocid{add\_left} \coqdocid{A} (\coqdocid{measure} : \coqdocid{A} \ensuremath{\rightarrow} \coqdocid{v}) (\coqdocid{a} : \coqdocid{A}) (\coqdocid{s} : \coqdocid{v})\coqdoceol
\coqdocindent{3.00em}
...
\coqdocindent{6.00em}
\coqor  \coqdocid{x} \ensuremath{\Rightarrow} \coqdocid{Deep} (\coqdocid{add\_digit\_left} \coqdocid{a} \coqdocid{pr}) \coqdocid{t'} \coqdocid{sf}\coqdoceol
\coqdocindent{5.00em}
\coqdockw{end}\coqdoceol
\coqdocindent{3.00em}
\coqdockw{end}.\coqdoceol
...
\begin{frame}
  ...
  \begin{block}{Two hundred lines, one hundred obligations concatenation}
    \coqdocindent{1.00em}
    \coqdockw{Definition} \coqdocid{app} (\coqdocid{A} : \coqdockw{Type}) (\coqdocid{measure} : \coqdocid{A} \ensuremath{\rightarrow} \coqdocid{v}) \coqdoceol
    \coqdocindent{2.00em}
  ...
  \begin{block}{Splitting nodes}

  \scriptsize{\coqdocindent{1.00em}
\coqdockw{Program Definition} \coqdocid{splitNode} (\coqdocid{p} : \coqdocid{v} \ensuremath{\rightarrow} \coqdocid{bool}) (\coqdocid{i} : \coqdocid{v}) (\coqdocid{n} : \coqdocid{node} \coqdocid{measure}) : \coqdoceol
\coqdocindent{1.00em}
...
\begin{frame}
  ...
  \begin{block}{The development}
    ...
    \item Certified implementation of Finger Trees. 
      Elegant certified implementation of sequences built on top of Finger Trees.
  ...
  \begin{block}{Conclusions}
    \begin{itemize}
    \item \Program scales pretty well ;
    \item \Coq would benefit from more language technology, e.g:
      overloading ;
    \item Subset types are a very natural device ;
    \item Dependent types are a powerfull specification tool ;
    \item $"=>"$ Difficulties with reasonning and computing.
    \end{itemize}   
  \end{block}
...
\begin{frame}
  ...
  \begin{block}{Future work}
    Reasonning support through tactics, enriched reduction with proof-irrelevance.
  \end{block}
