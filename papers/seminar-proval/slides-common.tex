...
\coqdocid{nodeMeasure} \coqdocid{m} \ensuremath{\rightarrow} \ensuremath{\forall} \coqdocid{r} : \coqdocid{digit} \coqdocid{A}, \coqdoceol
\coqdocindent{2.00em}
...
\medskip
\coqdocindent{2.00em}
\coqdockw{Program Fixpoint} \coqdocid{add\_left} \coqdocid{A} (\coqdocid{measure} : \coqdocid{A} \ensuremath{\rightarrow} \coqdocid{v}) (\alert{\coqdocid{a}} : \coqdocid{A}) (\alert{\coqdocid{s}} : \coqdocid{v})\coqdoceol
\coqdocindent{3.00em}
...
\begin{frame}
  \frametitle{Euclidian division from the standard library}  
\scriptsize{\coqdocindent{0.50em}
\coqdockw{Inductive} \coqdocid{diveucl} \coqdocid{a} \coqdocid{b} : \coqdockw{Set} :=\coqdoceol
\coqdocindent{1.50em}
\coqdocid{divex} : \ensuremath{\forall} \coqdocid{q} \coqdocid{r}, \coqdocid{b} > \coqdocid{r} \ensuremath{\rightarrow} \coqdocid{a} = \coqdocid{q} \ensuremath{\times} \coqdocid{b} + \coqdocid{r} \ensuremath{\rightarrow} \coqdocid{diveucl} \coqdocid{a} \coqdocid{b}.\coqdoceol


\medskip
\coqdocindent{0.50em}
\coqdockw{Lemma} \coqdocid{eucl\_dev} : \ensuremath{\forall} \coqdocid{n}, \coqdocid{n} > 0 \ensuremath{\rightarrow} \ensuremath{\forall} \coqdocid{m}:\coqdocid{nat}, \coqdocid{diveucl} \coqdocid{m} \coqdocid{n}.\coqdoceol
\noindent
\coqdocindent{0.50em}
