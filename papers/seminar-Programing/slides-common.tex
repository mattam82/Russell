...
\pgfdeclareimage[interpolate=true,height=5cm]{fingertree}{figures/FingerTree-ex}
...
\begin{frame}[t]
  ...
  (\coqdocid{node\_measure} \coqdocid{A} \coqdocid{measure}) \coqdocid{m} \ensuremath{\to} \ensuremath{\forall} \coqdocid{r} : \coqdocid{digit} \coqdocid{A}, \coqdoceol
  \coqdocindent{2.00em}
