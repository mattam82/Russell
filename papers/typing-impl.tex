...
\newcommand{\PiLeftTeq}{
  \UAX{PiLeftTeq}
  {}
  {$\teq{`G}{\pi_1~\pair{\Sigma x : T.V}{e_1}{e_2}}{T}{e_1}{T}$}
  {}
}
...
\newcommand{\PiRightTeq}{
  \UAX{PiRightTeq}
  {}
  {$\teq{`G}{\pi_2~\pair{\Sigma x : V.T}{e_1}{e_2}}{T}{e_2}{T}$}
  {}
}

\newcommand{\AppTeq}{
  \QAX{AppTeq}
  {$\teq{`G}{M}{S}{M'}{T} \quad \teq{`G}{N}{U}{N'}{V}$}
  {$S \sub \Pi x : A.B \quad T \sub \Pi x : C.D$}
  {$U \sub A$}
  {$V \sub C$}
...
\newcommand{\PairTeq}{
  ...
  {$\teq{`G}{\pair{\Sigma x : A.B}{e_1}{e_2}}{T}{\pair{\Sigma x :
        C.D}{e_1'}{e_2'}}{U}$}
  {}
}
