...
\begin{proof}
  ...
  \begin{induction}
    ...
    \begin{itemize}
      ...
      d\ipux$. 
      Par le lemme \ref{coerce-hnf} on a donc une dérivation de 
...
\begin{proof}
  ...
  Par induction la dérivations de $t$.
  ...
  \begin{induction}
    ...
    Par le lemme \ref{coerce-subst} on a $\subimpl{`D}{c_e[`r]}{E}{A}$.

    On a donc les coercions suivantes dans l'environnement $e$:   
    \[
    \xymatrix{
      E\ar[rr]_{c_e[`r]} & & 
      A\ar[d]^{c_1} \\
