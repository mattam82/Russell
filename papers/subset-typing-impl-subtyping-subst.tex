...
\begin{proof}
  ...
  \begin{induction}
    ...
    coercion \ref{coerce-refl}, $\subimpl{\Gr}{c'}{u}{u}$ est dérivable et $c' \eqbre
...
\begin{proof}
  ...
  \begin{induction}
    ...
    \begin{prooftree}
      ...
      {$\subimpl{`G}{t}{(c_1[\pi_1~\ctxdot], c_2~[\pi_2~\ctxdot])}
    ...
    \[\begin{array}{ll}
      \firsteq{
        ((c_1[\pi_1~\ctxdot], c_2[\pi_2~\ctxdot]))[`r]}
      
        \step{Définition de la substitution}
        {=}{((c_1[`r])[\pi_1~\ctxdot], (c_2[`r])[\pi_2~\ctxdot])}

        \step{Coercion identité dans $`s$}
        {=}{((c_1[`r])[\pi_1~\ctxdot], (c_2[`s])[\pi_2~\ctxdot])}
      \end{array} 
      \]
