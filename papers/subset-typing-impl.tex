...
\begin{prooftree}
  \AXC{$\nat \eqb \nat$}
  \UIC{$\subimpl{`G'}{[]}{\nat}{\nat}$}
  \UIC{$\subimpl{`G'}{\pi_1~[]}{\mysubset{x}{\nat}{P}}{\nat}$}

  \AXC{$(\listml~n)[\pi_1~n/n] \eqb \listml~(\pi_1~n)$}
