...
\begin{frame}
  ...
  proving algorithms in the \Coq{} environment, giving the possibility
  to write algorithms as easily as in a pratical functionnal programming language
  while giving them as rich a specification as desired. This is achieved
  by extending conversion to an equivalence which relates types
