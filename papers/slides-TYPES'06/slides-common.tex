...
\begin{frame}[t]
  ...
  \begin{block}{\PVS{}}
    ...
    \item[{\bf --}] \PVS{} architecture not very safe.
    \end{itemize}  
  \end{block}
%   \pause 
%   \begin{block}{\Coq{}}
...
\begin{frame}[t]
  ...
  \item<2-> Interpretation to \CCI with metavariables, inserting coercions ; 
...
\begin{frame}
  ...
  \begin{block}{Further work}
    \vspace{0.2em}
    \begin{itemize}
    \item Application to other constructs ((co-)inductives) and commands.
...
\begin{frame}[t]
  \frametitle{Addendum: some pratical enhancements}
