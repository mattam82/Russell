...
\begin{abstract}
  ...
  ce problème, on propose un nouveau langage de description de programmes,
...
Nous avons de multiples directions dans lesquelles étendre notre
système. Le support des inductifs, des univers cumulatifs
et des définitions dans les contextes semblent des problèmes techniques
abordables. La possibilité d'utiliser \lng{} dans
d'autres parties de \Coq{} (énoncés de lemmes, termes de tactiques) est
aussi un objectif intéressant. Modifier \Coq{} pour qu'il gère mieux les
existentielles est aussi un problème crucial dont nous avons fait
l'expérience durant le développement de \Subtac{}.
