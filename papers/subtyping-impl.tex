...
\newcommand{\subimplhnf}[4]{#1 \typec #2 : #3 {\subihnf}
  #4}
...
{$\subimplhnf{`G}{\lambda f : \Pi x : T.V.~\lambda x : U.~c_2~(f~(c_1~x))}{\Pi x : T.V}{\Pi x : U.W}$}
{}
}
...
%{$`G, x : U \typec P : \Prop$}
{$\subimpl{`G}{c}{T}{U}$}
{$\subimplhnf{`G}{\lambda t : \mysubset{x}{T}{P}.~c~(\pi_1~t)}
  {\mysubset{x}{T}{P}}{U}$}
{}
}
