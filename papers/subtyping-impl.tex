...
\newcommand{\subimpln}[4]{#1 \typec #2 : \ipt{#3}{{#1}_1} \subi
  \ipt{#4}{{#1}_2}}
\newcommand{\subimplndiff}[6]{#1 \typec #2 : \ipt{#3}{#4} \subi \ipt{#5}{#6}}
\newcommand{\SubConvC}{%
\UAX{SubConv}
{$\ipt{T}{`G_1} \eqbi \ipt{U}{`G_2}$}
...
\def\SubProdC{%
\BAX{SubProd}
{$\subimplndiff{`G}{c_1}{U}{`G_2}{T}{`G_1}$}
{$`G, x : \ipt{U}{`G} \typec  \subimplndiff{`G, x : U}{c_2}{V}{`G, x \coloneqq c_1~x : U}{W}{`G}$}
...
\BAX{SubSigma}
{$\subimpln{`G}{c_1}{T}{U}$}
{$\subimpln{`G, x : T}{c_2}{V}{W[c_1~x/x]}$}
{$\subimpln{`G}
  {\lambda (x, y). (c_1~x, c_2~y)}
  {\Sigma x : T. V}{\Sigma x : U. W}$}
{}
