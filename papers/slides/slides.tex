...
\begin{frame}
  ...
  \item<1-> Le plus haut sommet du cube de Barendregt ; \\
    ...
    \note<1>{Refaire le dessin avec juste $\lambda{\rightarrow}$ et
  ...
  \item<3-> Mêle logique et calcul.
    \note<3>{Pas de séparation nette entre calcul et preuve dans les termes}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item<2-> Distinction entre parties informatives et logiques dans
    le système de type. \uncover<3->{Extraction vers du code efficace.}
  \end{itemize}
