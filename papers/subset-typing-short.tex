...
des quatres couleurs \ref{WernerGonthier4col} récemment terminée utilisait des résultats de
...
\note{Si l'on peut utiliser $x$ dans t, on peut inférer le bon type
  $`t$!}
...
\cite{beppeConflict}) et la règle pour le produit cartésien covariante 
...
l'élimination des coupures dans les syst 
