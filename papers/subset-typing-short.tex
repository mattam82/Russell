...
\Coq~et la réutilisabilité des programmes générés.
...
langage de \Coq{} mais conservant sa richesse expressive (types
dépendants) et permettant de séparer les développements algorithmiques et
logiques de l'utilisateur. La correction des termes engendrés est
