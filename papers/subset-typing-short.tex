...
sans une expertise approfondie (voir \TODO{Annexe}?). Pour remédier à ce
...
(certification d'un compilateur {\sc \C}, théoreme des quatres couleurs
...
été développée dans \DML \cite{DML}, Cayenne \cite{Cayenne} et . Il
...
correspondant (voir \ref{annexe:subtac-example}). 
