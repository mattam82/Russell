...
de $P[t/x]$. Seulement, en \Coq{}, le type sous-ensemble est codé par
inductif avec un unique constructeur $\sref{elt}$ prenant en arguments
...
"->" x \neq 0$ de notre exemple est nécessaire pour avoir
