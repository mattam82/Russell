...
Inductive ins_in_lenv A : nat -> lenv -> lenv -> Prop :=
| ins_O : forall e, ins_in_lenv A 0 e (A :: e)
    | ins_S :
        forall n e f t,
        ins_in_lenv A n e f ->
        ins_in_lenv A (S n) (t :: e) (llift_rec 1 t n :: f).
...
Qed.
  ...
  Inductive sub_in_lenv t T : nat -> lenv -> lenv -> Prop :=
    | sub_O : forall e, sub_in_lenv t T 0 (T :: e) e
    | sub_S :
        forall e f n u,
        sub_in_lenv t T n e f ->
        sub_in_lenv t T (S n) (u :: e) (lsubst_rec t u n :: f).
...
Qed.
  ...
  Lemma nth_sub_eq : forall t T n e f, sub_in_lenv t T n e f -> item _ T e n.
simple induction 1; auto with coc core arith datatypes.
Qed.
